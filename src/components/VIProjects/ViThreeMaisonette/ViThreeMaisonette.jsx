...
import PropImage from "../../../assets/3maisonette1.jpg";
...
import ViMap from "../ViMap";
import ViThreeMaisonetteGallary from "../ViThreeMaisonette/ViThreeMaisonetteGallary";

const ViThreeMaisonette = () => {
 return (
   <section>
     {/*  HERO SECTION */}
       ...
       <div className="md:w-1/2 w-full md:px-0 px-5 md:mt-10 mt-10 flex items-start flex-col justify-center md:gap-8 gap-5">
         ...
         <div>
           <h2 className="flex gap-5 items-end justify-center md:text-[30px] text-[20px]">
             PRICE <span className="text-[#dfbf6c] md:text-[20px]">XXXXXX</span>
           </h2>
         </div>
     ...
     {/* PROJECT GALLARY */}
     <div className="max-w-7xl mx-auto md:p-0 p-5 md:mt-20 mt-7">
       <h2 className="text-[#dfbf6c] md:text-[50px] text-[30px] md:mb-5 mb-2">
         GALLERY
       </h2>
       <ViThreeMaisonetteGallary />
     </div>
     {/* MAP */}
     <div>
       <ViMap />
...
export default ViThreeMaisonette;
